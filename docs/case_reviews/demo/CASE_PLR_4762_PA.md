# Case Review — PLR_4762_PA (Critical)

## 1) Case Header
- case_id: CASE-PLR_4762_PA
- player_id: PLR_4762_PA
- state_jurisdiction: PA
- risk_category: CRITICAL
- composite_risk_score: 0.858
- primary_driver: LOSS_CHASE
- review_status: SUBMITTED
- score_calculated_at: 2026-02-24 11:41:27.753000-05:00

## 2) Evidence Summary (What Stands Out)
- Composite score is 0.858 with primary driver `LOSS_CHASE`.
- Component profile: loss_chase=1.000, bet_escalation=1.000, market_drift=0.330, temporal=1.000, gamalyze=0.793.
- Recent intensity: 61 bets / $31,877.45 wagered in 7d; 113 bets / $51,233.33 in 90d.
...
```
- Output summary: 1 row returned for PLR_4762_PA with category `CRITICAL` and composite `0.858`.
...
```
- Output summary: total_bets_7d=61, total_wagered_7d=$31,877.45, avg_bet_7d=$522.58, max_bet_7d=$743.83
...
FROM ordered;
```
- Output summary: avg_after_loss=$632.15, avg_after_win=$151.62, after_loss_ratio=4.17
...
LIMIT 1;
```
- Output summary: assessment_date=2025-12-09, sensitivity_to_loss=100.00, sensitivity_to_reward=64.89, risk_tolerance=63.53, decision_consistency=28.00, version=v3.2.1
...
- Sample-size check: 113 bets in 90d (sufficient for ratio interpretation).
