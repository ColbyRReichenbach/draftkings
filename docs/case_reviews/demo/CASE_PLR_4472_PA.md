# Case Review — PLR_4472_PA (High)

## 1) Case Header
- case_id: CASE-PLR_4472_PA
- player_id: PLR_4472_PA
...
- Recent intensity: 64 bets / $11,806.77 wagered in 7d; 113 bets / $20,774.02 in 90d.
...
```
- Output summary: 1 row returned for PLR_4472_PA with category `HIGH` and composite `0.800`.
...
```
- Output summary: total_bets_7d=64, total_wagered_7d=$11,806.77, avg_bet_7d=$184.48, max_bet_7d=$314.25
...
FROM ordered;
```
- Output summary: avg_after_loss=$247.82, avg_after_win=$62.68, after_loss_ratio=3.95
...
LIMIT 1;
```
- Output summary: assessment_date=2025-11-21, sensitivity_to_loss=79.72, sensitivity_to_reward=67.47, risk_tolerance=81.20, decision_consistency=64.75, version=v3.2.1
