# Case Review — PLR_6779_NJ (High)

## 1) Case Header
- case_id: CASE-PLR_6779_NJ
...
- Recent intensity: 41 bets / $7,556.12 wagered in 7d; 103 bets / $19,451.95 in 90d.
...
```
- Output summary: 1 row returned for PLR_6779_NJ with category `HIGH` and composite `0.800`.
...
```
- Output summary: total_bets_7d=41, total_wagered_7d=$7,556.12, avg_bet_7d=$184.30, max_bet_7d=$313.24
...
FROM ordered;
```
- Output summary: avg_after_loss=$240.60, avg_after_win=$63.36, after_loss_ratio=3.80
...
LIMIT 1;
```
- Output summary: assessment_date=2025-11-04, sensitivity_to_loss=85.63, sensitivity_to_reward=73.20, risk_tolerance=63.64, decision_consistency=24.77, version=v3.2.1
...
- Sample-size check: 103 bets in 90d (sufficient for ratio interpretation).
