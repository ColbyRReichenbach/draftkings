# Case Review — PLR_0193_MA (Medium)

## 1) Case Header
- case_id: CASE-PLR_0193_MA
- player_id: PLR_0193_MA
...
- Composite score is 0.598 with primary driver `LOSS_CHASE`.
- Component profile: loss_chase=0.762, bet_escalation=1.000, market_drift=0.042, temporal=0.127, gamalyze=0.500.
- Recent intensity: 63 bets / $7,801.94 wagered in 7d; 111 bets / $13,487.80 in 90d.
...
```
- Output summary: 1 row returned for PLR_0193_MA with category `MEDIUM` and composite `0.598`.
...
```
- Output summary: total_bets_7d=63, total_wagered_7d=$7,801.94, avg_bet_7d=$123.84, max_bet_7d=$414.11
...
FROM ordered;
```
- Output summary: avg_after_loss=$147.93, avg_after_win=$85.33, after_loss_ratio=1.73
...
LIMIT 1;
```
- Output summary: assessment_date=2025-10-21, sensitivity_to_loss=58.02, sensitivity_to_reward=51.53, risk_tolerance=62.40, decision_consistency=59.19, version=v3.2.1
