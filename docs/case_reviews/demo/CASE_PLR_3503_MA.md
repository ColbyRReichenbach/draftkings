# Case Review — PLR_3503_MA (Critical)

## 1) Case Header
- case_id: CASE-PLR_3503_MA
- player_id: PLR_3503_MA
- state_jurisdiction: MA
- risk_category: CRITICAL
- composite_risk_score: 0.849
- primary_driver: BET_ESCALATION
- review_status: SUBMITTED
- score_calculated_at: 2026-02-24 11:41:27.753000-05:00

## 2) Evidence Summary (What Stands Out)
- Composite score is 0.849 with primary driver `BET_ESCALATION`.
- Component profile: loss_chase=0.898, bet_escalation=1.000, market_drift=0.330, temporal=1.000, gamalyze=0.903.
- Recent intensity: 54 bets / $27,784.89 wagered in 7d; 117 bets / $58,637.88 in 90d.
...
```
- Output summary: 1 row returned for PLR_3503_MA with category `CRITICAL` and composite `0.849`.
...
```
- Output summary: total_bets_7d=54, total_wagered_7d=$27,784.89, avg_bet_7d=$514.53, max_bet_7d=$744.02
...
FROM ordered;
```
- Output summary: avg_after_loss=$697.37, avg_after_win=$150.76, after_loss_ratio=4.63
...
LIMIT 1;
```
- Output summary: assessment_date=2025-11-25, sensitivity_to_loss=92.03, sensitivity_to_reward=89.49, risk_tolerance=93.85, decision_consistency=23.74, version=v3.2.1
...
- Sample-size check: 117 bets in 90d (sufficient for ratio interpretation).
