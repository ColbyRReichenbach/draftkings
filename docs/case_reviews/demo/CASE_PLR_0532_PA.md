# Case Review — PLR_0532_PA (Critical)

## 1) Case Header
- case_id: CASE-PLR_0532_PA
- player_id: PLR_0532_PA
- state_jurisdiction: PA
- risk_category: CRITICAL
- composite_risk_score: 0.874
- primary_driver: LOSS_CHASE
- review_status: SUBMITTED
- score_calculated_at: 2026-02-24 11:41:27.753000-05:00

## 2) Evidence Summary (What Stands Out)
- Composite score is 0.874 with primary driver `LOSS_CHASE`.
- Component profile: loss_chase=1.000, bet_escalation=1.000, market_drift=0.330, temporal=1.000, gamalyze=0.873.
- Recent intensity: 60 bets / $107,395.84 wagered in 7d; 118 bets / $204,902.14 in 90d.
...
```
- Output summary: 1 row returned for PLR_0532_PA with category `CRITICAL` and composite `0.874`.
...
```
- Output summary: total_bets_7d=60, total_wagered_7d=$107,395.84, avg_bet_7d=$1,789.93, max_bet_7d=$2,423.80
...
FROM ordered;
```
- Output summary: avg_after_loss=$2,269.91, avg_after_win=$471.65, after_loss_ratio=4.81
...
LIMIT 1;
```
- Output summary: assessment_date=2025-11-16, sensitivity_to_loss=88.20, sensitivity_to_reward=73.13, risk_tolerance=100.00, decision_consistency=13.01, version=v3.2.1
...
- Sample-size check: 118 bets in 90d (sufficient for ratio interpretation).
