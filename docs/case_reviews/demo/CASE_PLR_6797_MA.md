# Case Review — PLR_6797_MA (Medium)

## 1) Case Header
- case_id: CASE-PLR_6797_MA
- player_id: PLR_6797_MA
...
- Component profile: loss_chase=0.524, bet_escalation=1.000, market_drift=0.196, temporal=0.593, gamalyze=0.500.
- Recent intensity: 44 bets / $3,718.82 wagered in 7d; 97 bets / $7,581.50 in 90d.
...
```
- Output summary: 1 row returned for PLR_6797_MA with category `MEDIUM` and composite `0.596`.
...
```
- Output summary: total_bets_7d=44, total_wagered_7d=$3,718.82, avg_bet_7d=$84.52, max_bet_7d=$290.07
...
FROM ordered;
```
- Output summary: avg_after_loss=$95.17, avg_after_win=$58.55, after_loss_ratio=1.63
...
LIMIT 1;
```
- Output summary: assessment_date=2025-11-23, sensitivity_to_loss=48.72, sensitivity_to_reward=42.14, risk_tolerance=36.86, decision_consistency=46.47, version=v3.2.1
...
- Sample-size check: 97 bets in 90d (sufficient for ratio interpretation).
