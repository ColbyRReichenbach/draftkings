# Case Review — PLR_9941_MA (Medium)

## 1) Case Header
- case_id: CASE-PLR_9941_MA
- player_id: PLR_9941_MA
- state_jurisdiction: MA
- risk_category: MEDIUM
- composite_risk_score: 0.597
- primary_driver: LOSS_CHASE
- review_status: SUBMITTED
- score_calculated_at: 2026-02-24 11:41:27.753000-05:00

## 2) Evidence Summary (What Stands Out)
- Composite score is 0.597 with primary driver `LOSS_CHASE`.
- Component profile: loss_chase=1.000, bet_escalation=0.408, market_drift=0.210, temporal=0.638, gamalyze=0.500.
- Recent intensity: 46 bets / $4,078.69 wagered in 7d; 86 bets / $7,393.56 in 90d.
...
```
- Output summary: 1 row returned for PLR_9941_MA with category `MEDIUM` and composite `0.597`.
...
```
- Output summary: total_bets_7d=46, total_wagered_7d=$4,078.69, avg_bet_7d=$88.67, max_bet_7d=$174.83
...
FROM ordered;
```
- Output summary: avg_after_loss=$91.23, avg_after_win=$78.91, after_loss_ratio=1.16
...
LIMIT 1;
```
- Output summary: assessment_date=2025-12-05, sensitivity_to_loss=41.70, sensitivity_to_reward=36.91, risk_tolerance=35.56, decision_consistency=49.38, version=v3.2.1
...
- Sample-size check: 86 bets in 90d (sufficient for ratio interpretation).
