# Case Review — PLR_1053_NJ (Medium)

## 1) Case Header
- case_id: CASE-PLR_1053_NJ
- player_id: PLR_1053_NJ
...
- Component profile: loss_chase=0.396, bet_escalation=0.964, market_drift=0.269, temporal=0.815, gamalyze=0.572.
- Recent intensity: 45 bets / $1,943.98 wagered in 7d; 93 bets / $4,620.44 in 90d.
...
```
- Output summary: 1 row returned for PLR_1053_NJ with category `MEDIUM` and composite `0.596`.
...
```
- Output summary: total_bets_7d=45, total_wagered_7d=$1,943.98, avg_bet_7d=$43.20, max_bet_7d=$136.40
...
FROM ordered;
```
- Output summary: avg_after_loss=$59.08, avg_after_win=$30.87, after_loss_ratio=1.91
...
LIMIT 1;
```
- Output summary: assessment_date=2025-12-30, sensitivity_to_loss=59.55, sensitivity_to_reward=55.59, risk_tolerance=58.29, decision_consistency=50.52, version=v3.2.1
...
- Sample-size check: 93 bets in 90d (sufficient for ratio interpretation).
