# Case Review — PLR_5352_NJ (High)

## 1) Case Header
- case_id: CASE-PLR_5352_NJ
- player_id: PLR_5352_NJ
...
- Recent intensity: 59 bets / $43,463.93 wagered in 7d; 123 bets / $90,551.67 in 90d.
...
```
- Output summary: 1 row returned for PLR_5352_NJ with category `HIGH` and composite `0.800`.
...
```
- Output summary: total_bets_7d=59, total_wagered_7d=$43,463.93, avg_bet_7d=$736.68, max_bet_7d=$1,070.93
...
FROM ordered;
```
- Output summary: avg_after_loss=$958.83, avg_after_win=$219.72, after_loss_ratio=4.36
...
LIMIT 1;
```
- Output summary: assessment_date=2025-12-01, sensitivity_to_loss=94.76, sensitivity_to_reward=85.90, risk_tolerance=85.18, decision_consistency=26.10, version=v3.2.1
...
- Sample-size check: 123 bets in 90d (sufficient for ratio interpretation).
