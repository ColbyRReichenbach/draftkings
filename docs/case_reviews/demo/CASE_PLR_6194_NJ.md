# Case Review — PLR_6194_NJ (Medium)

## 1) Case Header
- case_id: CASE-PLR_6194_NJ
- player_id: PLR_6194_NJ
- state_jurisdiction: NJ
- risk_category: MEDIUM
- composite_risk_score: 0.596
- primary_driver: LOSS_CHASE
- review_status: SUBMITTED
- score_calculated_at: 2026-02-24 11:41:27.753000-05:00

## 2) Evidence Summary (What Stands Out)
- Composite score is 0.596 with primary driver `LOSS_CHASE`.
- Component profile: loss_chase=0.762, bet_escalation=1.000, market_drift=0.000, temporal=0.000, gamalyze=0.589.
- Recent intensity: 49 bets / $5,612.85 wagered in 7d; 81 bets / $8,833.41 in 90d.
...
```
- Output summary: 1 row returned for PLR_6194_NJ with category `MEDIUM` and composite `0.596`.
...
```
- Output summary: total_bets_7d=49, total_wagered_7d=$5,612.85, avg_bet_7d=$114.55, max_bet_7d=$425.10
...
FROM ordered;
```
- Output summary: avg_after_loss=$139.17, avg_after_win=$83.62, after_loss_ratio=1.66
...
LIMIT 1;
```
- Output summary: assessment_date=2025-11-07, sensitivity_to_loss=55.72, sensitivity_to_reward=64.62, risk_tolerance=54.87, decision_consistency=32.54, version=v3.2.1
...
- Sample-size check: 81 bets in 90d (sufficient for ratio interpretation).
