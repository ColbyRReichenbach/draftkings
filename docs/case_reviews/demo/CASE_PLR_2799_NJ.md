# Case Review — PLR_2799_NJ (High)

## 1) Case Header
- case_id: CASE-PLR_2799_NJ
- player_id: PLR_2799_NJ
...
- Recent intensity: 42 bets / $20,453.45 wagered in 7d; 99 bets / $47,597.73 in 90d.
...
```
- Output summary: 1 row returned for PLR_2799_NJ with category `HIGH` and composite `0.800`.
...
```
- Output summary: total_bets_7d=42, total_wagered_7d=$20,453.45, avg_bet_7d=$486.99, max_bet_7d=$780.48
...
FROM ordered;
```
- Output summary: avg_after_loss=$601.72, avg_after_win=$158.16, after_loss_ratio=3.80
...
LIMIT 1;
```
- Output summary: assessment_date=2025-10-25, sensitivity_to_loss=64.08, sensitivity_to_reward=86.50, risk_tolerance=81.60, decision_consistency=26.09, version=v3.2.1
...
- Sample-size check: 99 bets in 90d (sufficient for ratio interpretation).
