# Case Review — PLR_7701_PA (High)

## 1) Case Header
- case_id: CASE-PLR_7701_PA
- player_id: PLR_7701_PA
...
- Recent intensity: 61 bets / $85,086.12 wagered in 7d; 138 bets / $192,134.61 in 90d.
...
```
- Output summary: 1 row returned for PLR_7701_PA with category `HIGH` and composite `0.800`.
...
```
- Output summary: total_bets_7d=61, total_wagered_7d=$85,086.12, avg_bet_7d=$1,394.85, max_bet_7d=$1,896.31
...
FROM ordered;
```
- Output summary: avg_after_loss=$1,764.33, avg_after_win=$378.55, after_loss_ratio=4.66
...
LIMIT 1;
```
- Output summary: assessment_date=2025-11-07, sensitivity_to_loss=63.74, sensitivity_to_reward=73.10, risk_tolerance=96.19, decision_consistency=6.42, version=v3.2.1
...
- Sample-size check: 138 bets in 90d (sufficient for ratio interpretation).
