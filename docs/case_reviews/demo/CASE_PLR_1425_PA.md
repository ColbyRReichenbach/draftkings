# Case Review — PLR_1425_PA (High)

## 1) Case Header
- case_id: CASE-PLR_1425_PA
- player_id: PLR_1425_PA
...
- Recent intensity: 49 bets / $8,933.00 wagered in 7d; 90 bets / $15,236.90 in 90d.
...
```
- Output summary: 1 row returned for PLR_1425_PA with category `HIGH` and composite `0.800`.
...
```
- Output summary: total_bets_7d=49, total_wagered_7d=$8,933.00, avg_bet_7d=$182.31, max_bet_7d=$336.44
...
FROM ordered;
```
- Output summary: avg_after_loss=$229.62, avg_after_win=$65.37, after_loss_ratio=3.51
...
LIMIT 1;
```
- Output summary: assessment_date=2025-11-29, sensitivity_to_loss=31.55, sensitivity_to_reward=59.15, risk_tolerance=61.45, decision_consistency=29.22, version=v3.2.1
...
- Sample-size check: 90 bets in 90d (sufficient for ratio interpretation).
