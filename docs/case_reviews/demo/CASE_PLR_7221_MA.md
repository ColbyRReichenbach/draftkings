# Case Review — PLR_7221_MA (Medium)

## 1) Case Header
- case_id: CASE-PLR_7221_MA
- player_id: PLR_7221_MA
...
- Component profile: loss_chase=0.675, bet_escalation=1.000, market_drift=0.098, temporal=0.296, gamalyze=0.500.
- Recent intensity: 43 bets / $3,399.73 wagered in 7d; 88 bets / $5,991.25 in 90d.
...
```
- Output summary: 1 row returned for PLR_7221_MA with category `MEDIUM` and composite `0.597`.
...
```
- Output summary: total_bets_7d=43, total_wagered_7d=$3,399.73, avg_bet_7d=$79.06, max_bet_7d=$221.62
...
FROM ordered;
```
- Output summary: avg_after_loss=$91.55, avg_after_win=$43.44, after_loss_ratio=2.11
...
LIMIT 1;
```
- Output summary: assessment_date=2025-10-15, sensitivity_to_loss=79.77, sensitivity_to_reward=74.80, risk_tolerance=63.76, decision_consistency=39.86, version=v3.2.1
...
- Sample-size check: 88 bets in 90d (sufficient for ratio interpretation).
