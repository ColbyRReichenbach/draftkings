# Case Review — PLR_6168_PA (High)

## 1) Case Header
- case_id: CASE-PLR_6168_PA
- player_id: PLR_6168_PA
...
- Recent intensity: 70 bets / $39,166.60 wagered in 7d; 131 bets / $74,879.67 in 90d.
...
```
- Output summary: 1 row returned for PLR_6168_PA with category `HIGH` and composite `0.800`.
...
```
- Output summary: total_bets_7d=70, total_wagered_7d=$39,166.60, avg_bet_7d=$559.52, max_bet_7d=$910.02
...
FROM ordered;
```
- Output summary: avg_after_loss=$736.00, avg_after_win=$184.44, after_loss_ratio=3.99
...
LIMIT 1;
```
- Output summary: assessment_date=2025-10-09, sensitivity_to_loss=75.94, sensitivity_to_reward=68.88, risk_tolerance=70.48, decision_consistency=29.14, version=v3.2.1
...
- Sample-size check: 131 bets in 90d (sufficient for ratio interpretation).
